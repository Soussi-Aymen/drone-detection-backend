...
import { ISystemUpdatePayload, SYSTEM_UPDATE_CHANNEL, THREAT_UPDATE_CHANNEL } from '../common/interfaces/threat-track.interface';
...
export class RealtimeGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
    ...
    handleConnection(client: Socket, ...args: any[]) {
        ...
        client.emit(THREAT_UPDATE_CHANNEL, { message: 'Connected to real-time threat feed.' });
    }
